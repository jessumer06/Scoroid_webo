var num=1;var id=1;
var ids=1;var nid="stat";var frow=1;var hg=1;var hj=1;var x;
var one="no";var two="name";var three="rate";var four="button";
    var u=0;
    var aa=0;
      var z=1,cd,abcd=1,bc,ty,tg,we;
function addex(){

  document.getElementById("myModal").visible='hidden';
...
// var rdata=document.createElement("tr"+no);
...
for(i;i<zz;i++){
  var i=aa;
    ...
    for(i;i<zz;i++){
        ...
        document.getElementById("mtable").appendChild(head);
        ...
        if(p<3){
          ...
          x.setAttribute("id",no+p);
            x.setAttribute("class","form-control");
            x.setAttribute("style","height: 50px ; width:50px;");
                    x.value=id;
          ...
          x.setAttribute("id",no+p);
            x.setAttribute("class","form-control");
            x.setAttribute("style","height: 50px;width:350px;");
            document.getElementById(tg).appendChild(x);
          ...
          x.setAttribute("id",no+p);
            x.setAttribute("class","form-control");
            x.setAttribute("style","height: 50px;width:100px;");
            document.getElementById(tg).appendChild(x);
        }
...
function create_modal(no)
{

   document.getElementById("myModal").visible='visible';
